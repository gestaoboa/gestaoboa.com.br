...
const TOTAL_DURATION = 70000; // 70 segundos em milissegundos
...
const LogoBenefitsScene = () => (
    <div id="logo-benefits-section" className="animation-section">
        ...
        <div className="benefits-text-container">
            <p className="benefit-text benefit-text-1">Organize sua barbearia/salão</p>
    ...
    <div id="features-section" className="animation-section">
        <div className="features-content">
            <ul className="features-list">
                ...
                <li className="feature-list-item">Inteligência artificial</li>            </ul>
            <img 
                src="app.png" 
                alt="App Gestão Boa" 
                className="app-image"
    ...
    <div id="testimonial-section" className="animation-section">
        <div className="testimonial-content">
            ...
            <blockquote className="testimonial-text">
                "Hoje tenho clareza total dos números, consigo tomar decisões mais inteligentes e garantir a saúde financeira da barbearia."
            </blockquote>
            <cite className="testimonial-author">Leandro Figueiredo, Barbearia Duque</cite>
        </div>
    </div>
);
...
const CtaScene = () => (
    <div id="cta-section" className="animation-section">
        <div className="cta-container">
            <img 
                src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://gestaoboa.com.br&bgcolor=0B1B34&color=FFFFFF&qzone=1" 
                alt="QR Code para começar" 
                className="qr-code" 
                onError={(e) => { 
                    const target = e.target as HTMLImageElement;
                    target.onerror = null; 
                    target.src = 'https://placehold.co/150x150/ffffff/0B1B34?text=QRCode'; 
                }} 
            />
            <h2 className="cta-headline">Comece Agora!</h2>
            <p className="cta-subheadline">Aponte a câmera e revolucione sua gestão.</p>
        </div>
    </div>
);
...
export default function Anuncios() {
    ...
    useEffect(() => {
        ...
        const loopInterval = setInterval(() => {
            console.log('Loop restarting...'); // Debug log
            ...
            setTimeout(() => {
                ...
                setIsPlaying(true);
                console.log('Loop restarted!'); // Debug log
            }, 1000); // Increased to 1 second for smoother transition
        }, TOTAL_DURATION);
    ...
    return (
        <div className={`video-container ${isPlaying ? 'is-playing' : ''} ${isRestarting ? 'restarting' : ''}`}>
            <LogoBenefitsScene />
            <FeaturesScene />
            <TestimonialScene />
            <CtaScene />
