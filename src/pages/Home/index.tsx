					...
					<Banner id="start">
						<div className="content">
							...
							<div className="buttons">
								<a
									className="button"
									href="https://plataformagestaoboa.vercel.app"
					...
					<Solutions id="solution">
						...
						<div className="tutorial">
							<div className="callout">
								...
								<div className="buttons">
									<div className="top">
										<a href="https://play.google.com/store/apps/details?id=com.beasier" className="unfocused">
										...
										<a href="https://plataformagestaoboa.vercel.app" className="unfocused">
											<img src="/mage_playstore.svg" alt="" style={{ marginTop: "-6px" }} />
											IOS
										</a>
									</div>
									<a href="https://plataformagestaoboa.vercel.app" className="focused">
										Desktop
									</a>
								</div>
							</div>
					...
					<Contact id="contact">
						<div className="info">
							...
							<div className="links">
								...
								<a href="gestaoboa@outlook.com">
									<img src="/envelope-1@2x.png" alt="" />
									gestaoboa@outlook.com
								</a>
							</div>
						</div>
