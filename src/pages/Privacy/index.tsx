	...
	return (
		<Container>
			<Helmet>
				...
				<meta name="description" content="Nós adotamos esta Política de Privacidade, que determina como nós
			...
			<Content>
				...
				instalados no seu dispositivo. Além disso, quando você navega pelo
				Site, nós coletamos informações sobre as páginas individuais ou
				...
				como "Informações sobre o dispositivo". Além disso, nós podemos
				coletar dados pessoais que você fornecer (incluindo, mas não limitado
				...
				Apesar disso, nenhuma transmissão de dados pela Internet ou por
